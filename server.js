...
// Inisialisasi Firebase Admin (Pastikan fail serviceAccountKey.json ada dalam projek anda)
const serviceAccount = require('./serviceAccountKey.json'); // Sesuaikan laluan fail jika perlu
...
app.get('/refresh-token', async (req, res) => {
  try {
    ...
    // 🌟 Diubah kepada format JSON ringkas untuk elak ralat "output too large"[cite: 6]
    res.status(200).json({ 
      success: true, 
...
// Jangan lupa untuk tetapkan port untuk server mendengar[cite: 6]
